...
DATABASES = {
    ...
    "extra": {
        ...
        'NAME': os.getenv('APP_DB_NAME'), #os.getenv('APP_DB_NAME'),
        'USER': os.getenv('POSTGRES_ADMIN_USER'), #os.getenv('POSTGRES_ADMIN_USER'),
        "HOST": os.getenv('POSTGRES_HOST'), #os.getenv('POSTGRES_HOST'),
        'PORT': '5432',
        "PASSWORD": "",
        "OPTIONS": {
            "sslmode": "require"
